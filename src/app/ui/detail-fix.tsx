...
import { checkout, reset } from '../lib/actions'
...
export default function DetailFix({
  watermelons,
}: {
  ...
  const hintText = (reset: boolean)=>{
    ...
    const initialText = "This app simulates the solution. Press the space key to play the animation and see how the issue is resolved."
